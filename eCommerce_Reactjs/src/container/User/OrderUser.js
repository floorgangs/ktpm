                                ...
                                <div key={index}>
                                    ...
                                    <div className='content-bottom'>
                                        <div className='up'>
                                            ...
                                            <span className='name'>{item && item.voucherData && item.voucherData.id ? CommonUtils.formatter.format(totalPriceDiscount(price, item.voucherData) + (item.shippingFee || item.typeShipData?.price || 0)) : CommonUtils.formatter.format(price + (item.shippingFee || item.typeShipData?.price || 0))}</span>
